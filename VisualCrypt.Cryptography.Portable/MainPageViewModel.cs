...
{
    public sealed class MainPageViewModel : ViewModelBase, IActiveCleanup, IEditorContext
    {
		...
		public MainPageViewModel(IEventAggregator eventAggregator, ILog log,
			...
			IBrowserService browserService, IAssemblyInfoProvider assemblyInfoProvider,
			ILifeTimeService lifeTimeService, IClipBoardService clipBoardService,
