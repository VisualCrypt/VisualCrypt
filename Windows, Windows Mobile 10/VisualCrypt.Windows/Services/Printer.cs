...
namespace VisualCrypt.Windows.Services
{
    class Printer : IPrinter
    {
        ...
        public async void PrintEditorText(string editorText)
        {
            ...
            var printHelper = new PrintHelper(MainPagePhone.GetMainPageReference());
            ...
            printHelper.PreparePrintContent(pageToPrint);
            ...
            printTask = e.Request.CreatePrintTask("C# Printing SDK Sample", sourceRequested =>
            {
                ...
                printTask.Completed += async (s, args) =>
                {
                    ...
                    if (args.Completion == PrintTaskCompletion.Failed)
                    {
                        ...
                        {
                            Service.Get<IMessageBoxService>().ShowError("Failed to print.");
                        });
                    }
                };
