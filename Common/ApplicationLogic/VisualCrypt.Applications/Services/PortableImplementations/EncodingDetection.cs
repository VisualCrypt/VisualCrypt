...
{
    public class EncodingDetection : IEncodingDetection
    {
        bool _isPlatformDefaultEncodingSupplied;
        Encoding _platformDefaultEncoding;

        public Encoding PlatformDefaultEncoding
        {
            set
            {
                if (_isPlatformDefaultEncodingSupplied)
                    throw new InvalidOperationException("An instance of Encoding has already been supplied.");
                _platformDefaultEncoding = value;
                _isPlatformDefaultEncodingSupplied = true;
            }
        }
