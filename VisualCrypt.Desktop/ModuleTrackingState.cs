...
namespace VisualCrypt.Desktop
{
	...
	{
		string moduleName;
		ModuleInitializationStatus moduleInitializationStatus;
		DiscoveryMethod expectedDiscoveryMethod;
		InitializationMode expectedInitializationMode;
		DownloadTiming expectedDownloadTiming;
		string configuredDependencies = "(none)";
		long bytesReceived;
